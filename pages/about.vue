    ...
    <div class="gap-16 items-center py-8 px-4 m-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
        ...
        <div class="grid grid-cols-2 gap-4 mt-8">
            <div class="relative mb-auto">
              <NuxtImg src="/assets/09112023-PB092692-min.jpg" alt="Picture of owner Lasse Herold Krarup" class="w-full rounded-xl"></NuxtImg>
              <p class="pointer-events-none absolute bottom-0 right-0 text-white text-opacity-25 p-2 text-sm">&copy; Matthieu Lebas</p>
            </div>
            <div class="relative mt-4 w-full lg:h-[24rem] lg:mt-10 rounded-lg overflow-hidden m-auto">
              <NuxtImg src="/assets/lasseherold_circuit_diagram_on_paper_4f238059-f0ec-4633-9849-215b76d4b651.png" alt="Circuit schematic on paper" class="object-cover aspect-1 h-full w-full"></NuxtImg>
            </div>
        </div>
    </div>
</section>
