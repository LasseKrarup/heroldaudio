  ...
  <div class="max-w-xl mx-auto">
    <div class="text-center">
      ...
      <p class="mt-1 text-gray-600 dark:text-gray-400">
        Skriv en henvendelse i kontaktformularen herunder. Prøv at være så specifik som mulig, hvis du beskriver et problem på noget udstyr, du har. 
        Du er også velkommen til at ringe i stedet.
      </p>
    </div>
  </div>
      ...
      <form name="contact" netlify data-netlify="true">
        <div class="grid gap-4 lg:gap-6">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
            <div>
              <label for="hs-firstname-contacts-1" class="block mb-2 text-sm text-gray-700 font-medium dark:text-white">Fornavn</label>
            ...
            <div>
              <label for="hs-lastname-contacts-1" class="block mb-2 text-sm text-gray-700 font-medium dark:text-white">Efternavn</label>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
            ...
            <div>
              <label for="hs-phone-number-1" class="block mb-2 text-sm text-gray-700 font-medium dark:text-white">Telefon</label>
          ...
          <div>
            <label for="hs-about-contacts-1" class="block mb-2 text-sm text-gray-700 font-medium dark:text-white">Detaljer</label>
        ...
        <div class="mt-6 grid">
          <button type="submit" class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">Send besked</button>
        </div>

        <div class="mt-3 text-center">
          <p class="text-sm text-gray-500">
            Du får svar inden for 1-2 arbejdsdage.
          </p>
        </div>
      </form>
    </div>
